...
CREATE DATABASE [adminTools]
 CONTAINMENT = NONE
 ON  PRIMARY 
 -- !!!!!!!!!!!!!!!!!!!!!!!!! CHANGE DB FILE LOCATION !!!!!!!!!!!!!
 --*********************************************************************************************************************************************
( NAME = N'adminTools', FILENAME = N'C:\SQL\data\adminTools.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'adminTools_log', FILENAME = N'C:\SQL\Log\adminTools_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF

GO
ALTER DATABASE [adminTools] SET RECOVERY SIMPLE WITH ROLLBACK IMMEDIATE -- most probably you dont need full
GO

USE [adminTools]
GO
ALTER AUTHORIZATION ON DATABASE::[adminTools] TO [sa]
GO
